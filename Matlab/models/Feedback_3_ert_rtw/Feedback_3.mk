...
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Feedback_3.out
...
MODELREF_LINK_RSPFILE_NAME = Feedback_3_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Feedback_3.out
...
%.obj : $(START_DIR)/Feedback_3_ert_rtw/%.cla
	$(CC) $(CFLAGS) --output_file=$@ $<


%.obj : $(START_DIR)/Feedback_3_ert_rtw/%.c
	$(CC) $(CFLAGS) --output_file=$@ $<


%.obj : $(START_DIR)/Feedback_3_ert_rtw/%.asm
	$(AS) $(ASFLAGS) --output_file=$@ $<


%.obj : $(START_DIR)/Feedback_3_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) --output_file=$@ $<
