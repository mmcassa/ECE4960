###########################################################################
## Makefile generated for Simulink model 'stellaris_lp_debug_print'. 
## 
## Makefile     : stellaris_lp_debug_print.mk
## Generated on : Wed Sep 11 18:39:58 2019
## MATLAB Coder version: 3.4 (R2017b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/stellaris_lp_debug_print.out
...
PRODUCT_NAME              = stellaris_lp_debug_print
MAKEFILE                  = stellaris_lp_debug_print.mk
COMPUTER                  = PCWIN64
...
MODELREF_LINK_RSPFILE_NAME = stellaris_lp_debug_print_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/stellaris_lp_debug_print.out
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/stellaris_lp_debug_print_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(START_DIR)/slprj/ert/_sharedutils
...
DEFINES_ = -DMODEL=stellaris_lp_debug_print -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DTERMFCN=1 -DONESTEPFCN=1 -DMAT_FILE=0 -DMULTI_INSTANCE_CODE=0 -DINTEGER_CODE=0 -DMT=0 -DCLASSIC_INTERFACE=0 -DALLOCATIONFCN=0 -DTID01EQ=0 -DSTACK_SIZE=64 -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DRT
...
DEFINES_STANDARD = -DMODEL=stellaris_lp_debug_print -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO
...
%.obj : $(START_DIR)/stellaris_lp_debug_print_ert_rtw/%.cla
	$(CC) $(CFLAGS) --output_file=$@ $<


%.obj : $(START_DIR)/stellaris_lp_debug_print_ert_rtw/%.c
	$(CC) $(CFLAGS) --output_file=$@ $<


%.obj : $(START_DIR)/stellaris_lp_debug_print_ert_rtw/%.asm
	$(AS) $(ASFLAGS) --output_file=$@ $<


%.obj : $(START_DIR)/stellaris_lp_debug_print_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) --output_file=$@ $<
