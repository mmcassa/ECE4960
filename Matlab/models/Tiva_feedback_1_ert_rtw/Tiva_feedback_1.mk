###########################################################################
## Makefile generated for Simulink model 'Tiva_feedback_1'. 
## 
## Makefile     : Tiva_feedback_1.mk
## Generated on : Wed Sep 18 17:59:15 2019
## MATLAB Coder version: 3.4 (R2017b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Tiva_feedback_1.out
...
MODELREF_LINK_RSPFILE_NAME = Tiva_feedback_1_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Tiva_feedback_1.out
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(MATLAB_ROOT)/simulink/include/sf_runtime -I$(START_DIR)/Tiva_feedback_1_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_ = -DMODEL=Tiva_feedback_1 -DNUMST=3 -DNCSTATES=0 -DHAVESTDIO -DTERMFCN=1 -DONESTEPFCN=1 -DMAT_FILE=0 -DMULTI_INSTANCE_CODE=0 -DINTEGER_CODE=0 -DMT=1 -DCLASSIC_INTERFACE=0 -DALLOCATIONFCN=0 -DTID01EQ=0 -DSTACK_SIZE=64 -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DRT
...
DEFINES_STANDARD = -DMODEL=Tiva_feedback_1 -DNUMST=3 -DNCSTATES=0 -DHAVESTDIO
...
%.obj : $(START_DIR)/Tiva_feedback_1_ert_rtw/%.cla
	$(CC) $(CFLAGS) --output_file=$@ $<


%.obj : $(START_DIR)/Tiva_feedback_1_ert_rtw/%.c
	$(CC) $(CFLAGS) --output_file=$@ $<


%.obj : $(START_DIR)/Tiva_feedback_1_ert_rtw/%.asm
	$(AS) $(ASFLAGS) --output_file=$@ $<


%.obj : $(START_DIR)/Tiva_feedback_1_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) --output_file=$@ $<
